-- Canonical Spring Authorization Server JDBC schema (spring-security-oauth2-authorization-server 7.0.6),
-- adapted for PostgreSQL per the guidance in the shipped scripts:
--   * columns defined as 'blob'      -> 'text'        (PostgreSQL has no 'blob' type)
--   * columns defined as 'timestamp' -> 'timestamptz' (store time instants accurately)
-- Sources:
